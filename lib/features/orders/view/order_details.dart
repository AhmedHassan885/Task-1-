...
import 'package:course/features/orders/view/widgets/book_button.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                BookButton(text: AppStrings.cancel_text),
                SizedBox(
                  width: 15,
                ),
                BookButton(text: AppStrings.track_text)
              ],
            )
          ],
        ),
